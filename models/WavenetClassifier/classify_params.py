...
def get_model_name(model_params):
    return "{}/CatClassification/Movies:{}/SplitBy:{}/AvsW:{}/WvNet_L:{}_Concat:{}_Ep:{}_Lr:{}_BS:{}_Fltrs:{}_SkipFltrs:{}_L2:{}_Norm:ZscBrute_GradClip:{}_LPass:{}_Seed:{}_TrainTest:{}_WinSize:{}_ClassW:{}/PID:{}__Date:{}".format(

...
from datasets.paths import MOUSE_CONTROL_DATASET_SIGNAL_PATH, MOUSE_CONTROL_DATASET_STIMULI_PATH


class MouseControlDataset(LFPDataset):
    def __init__(self,
                 val_percentage=0.0,
        ...
        super().__init__(
            ...
            stimuli_path=MOUSE_CONTROL_DATASET_STIMULI_PATH,

...
def get_wavenet_dcgan_model(nr_filters, input_shape, nr_layers, lr, loss, clipvalue, skip_conn_filters,
    ...
    generator = Dense(6 * generator_filter_size * img_size // 16 * img_size // 16, activation="relu")(net)
    generator = Reshape((img_size // 16, img_size // 16, generator_filter_size * 6))(generator)
    # generator = BatchNormalization()(generator)
    generator = Activation('relu')(generator)
    generator = deconv2d(generator, filters=generator_filter_size * 3, bn_relu=False)
